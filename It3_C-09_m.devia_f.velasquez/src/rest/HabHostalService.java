...
public class HabHostalService {
	...
	@POST
	public Response postHabHostal(HabHostal hb, @QueryParam("token")Long token) {
		AlohAndesTransactionManager tm = new AlohAndesTransactionManager(getPath());
		
		try {
			tm.registrarHabitacionHostal(hb, token);
			return Response.status(200).entity(hb).build();
		}
