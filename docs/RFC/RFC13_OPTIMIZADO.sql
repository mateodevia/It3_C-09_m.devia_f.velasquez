...
FROM
    ...
    (   
        ...
        FROM
            (   SELECT CLIENTES.CARNET_UNIANDES
                --Se hace este join, porque sólo interesan clientes con al menos una reserva.
    ...
    (   SELECT CARNET_UNIANDES, '2' AS JUSTIFICACION 
        FROM
            (   SELECT CLIENTES.CARNET_UNIANDES 
                --Se hace este join, porque sólo interesan clientes con al menos una reserva en habitaciones de hotel
